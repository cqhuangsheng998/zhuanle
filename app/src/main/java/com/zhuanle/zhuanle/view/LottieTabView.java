package com.zhuanle.zhuanle.view;
...
public class LottieTabView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextNormalColor = ta.getColor(R.styleable.LottieTabView_text_normal_color,Color.GRAY);
        mTextSelectColor = ta.getColor(R.styleable.LottieTabView_text_selected_color, Color.BLUE);
        mTextSize = ta.getDimension(R.styleable.LottieTabView_text_size, 20);
